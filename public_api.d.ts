...
import { FileManagerConfig, NameUid } from './lib/configuration/client-configuration';
...
export { NgxFilemanagerClientFirebaseModule, NameUid, FileManagerConfig, ServerFilesystemProviderService, FileSystemStub };
